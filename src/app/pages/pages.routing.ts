...
const routes: Routes = [
    {
        ...
        children: [
            ...
            // { path: 'hospitales', component: UsuariosComponent, data: {titulo: 'Hospitales de la Aplicación'} },
            // { path: 'medicos', component: UsuariosComponent, data: {titulo: 'Medicos de la Aplicación'} }
        ]
    },
];
